...
### 2018年1月: IAMASでの修士作品と修士論文

2016年から2018年にかけて「**多層時間構造による音楽創造の試みと、演奏者・聴衆の身体化の可能性**」について研究を行いました。修士作品・映像と修士論文をそれぞれ1点制作しました。

#### 修士作品について

修士作品は「**Music for multilayered temporal structures**」と名付けました。ジャズのリードシート形式の楽譜3曲と、ミュージシャンへの「演奏の仕方」を記した指示書から成っています。以下のURLから読むことができます。

* [日本語版はこちら](https://drive.google.com/file/d/1bUWBULipnMCDW39T08ccRaGEZsjCWOUq/view)
* [英語版はこちら](https://drive.google.com/file/d/1-L03xHCOUF6yZhvX4Bmkz-GtfrdR_0x8/view)

また、ミュージシャンが実際にこのような曲をどう演奏するかの実験映像を撮影しました。下記からご覧いただけます。この録音では各ミュージシャンはリズムキープのためのクリックを一切使用していません。ミュージシャンたちは指示書を通じて作品のコンセプトの構造を理解し、協力して演奏しています。
...
修士論文「**多層時間構造による音楽創造の試みとその身体化の可能性**」もGitHub経由で公開しています。英語版のアブストラクトをここに紹介します。

> 本研究は二つの主題を扱う。一つは、特定の構造の中で二つ以上のテンポを使用した音楽創造の試みについて。もう一つは、聴衆と演奏者にとっての音楽の身体化の可能性について。
>
> 現代のポピュラー音楽のリズムは、4拍子や3拍子といった一般的なリズムに支配されている。これは、音楽理論やDTM/MIDIなどの現在の音楽制作環境が楽譜システムの影響を受けているためと推測する。しかし21世紀初頭、アフリカ系アメリカ人のミュージシャンたちは意図的なポリリズム的揺れやアクセントを導入した。このリズム史における転換点は、ジャズにおけるモードシステムの登場や現代音楽における無調性と同じくらい重要と考えられている。
>
> これが本研究の背景である。リズムには現在の楽譜システムでは捉えきれない多様性があり、人々の音楽体験を更新する可能性を持っている。そして音という媒体を扱う時、音とテクノロジー、音と身体の関係を無視することはできない。
>
> 本論では、まずジャズからポピュラー音楽への動きを再解釈し、クラシック音楽から現代音楽への動きと並行して比較する。両方の動きに着目するアプローチにより、音楽の現状を明らかにできる。このアプローチの中で、西洋音楽の文脈で正しく理解されてこなかったポリリズムとクロスリズムに焦点を当てる。次に、現在行われているリズムアプローチとの違いと新規性を示すために、ポリリズムやその他の複雑なリズムを使ったリズムのバリエーションを検討する。そして、私の方法でリズムをどのように演奏できるかの可能性を示す。このアプローチが音楽体験に貢献し、新たな「演奏」と「聴取」の行為の創造につながると信じている。
>
> 本研究はリズムの多様性に関するものであり、次世代の音楽と身体の関係における新たな可能性を発見する試みである。

修士論文は以下のURLから読むことができます（日本語版のみ。英語版は翻訳中です）。
